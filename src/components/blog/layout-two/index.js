                ...
                <BlogInner>
                    ...
                    <BlogContent>
                        <BlogHeader> 
                            ...
                            {title && <BlogTitle><Link to={`/post/${slug}`}>{title}</Link></BlogTitle>}
                            <BlogMetaWrap>
                                {date && (
                                    <BlogMeta>
                                        {date.slice(0,10)}
                                ...
                                <BlogMeta>
                                    <CommentNumber slug={slug} title={title} id={slug}/>
                                </BlogMeta>
                            </BlogMetaWrap>
                        </BlogHeader>
                        {excerpt && <BlogExcerpt><div dangerouslySetInnerHTML={{ __html: excerpt }} />
                        </BlogExcerpt>}
                        <BlogFooter>
                            <Button {...btnStyle} icon={<FiChevronRight/>} to={`/post/${slug}`}>Больше</Button>
                        </BlogFooter>
                    </BlogContent>
                </BlogInner>
            </BlogWrapper>
