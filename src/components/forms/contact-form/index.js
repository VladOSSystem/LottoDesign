...
const ContactForm = ({ formgroupCSS, textareaCSS, btnCSS, url }) => {
    ...
    const onSubmit = (data, e) => {
        ...
        axios({
            ...
            .then(res => {
                handleServerResponse(true, "Спасибо за сообщение!", form);
            })
            .catch(err => {
    ...
    return (
        <ContactFormWrap>
            <From onSubmit={handleSubmit(onSubmit)}>
                <Row>
                    ...
                    <Col lg={6}>
                        <FormGroup
                            ...
                            ></Textarea>
                            <Label htmlFor="message">Напиши сдесь.</Label>
                ...
                <Row>
                    <Col lg={12}>
                        <Button type="submit" {...btnCSS} disabled={serverState.submitting} icon={<FiChevronRight />}>Подтвердить</Button>
                        {serverState.status && (
